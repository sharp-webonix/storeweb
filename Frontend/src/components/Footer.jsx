  ...
  return (
    <div className="bg-gray-100 px-[200px] h-[60vh] mt-[50px]">
      <div className="flex justify-between py-[5%]">
        <div>
          <img src="../asset/logo1.png" alt="" height={150} width={150} />
          <p className="mt-2"></p>
        </div>
        ...
        <div className="w-full md:w-1/3">
          ...
          <p className="mt-2">Opp. Roadways bus stand Kashipur(Uttarakhand)</p>
          <p className="mt-2">Phone:9758105523</p>
          <p className="mt-2">Email: sharp_systemsksp@yahoo.co.in</p>
        </div>
      </div>
      <div className="mt-8 border-t border-[#e9acd9] pt-4 text-center">
        <p>&copy; 2024 Sharp System. All rights reserved.</p>
