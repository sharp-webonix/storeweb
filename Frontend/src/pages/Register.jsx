    ...
    <div className="flex items-center bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="p-10 w-[500px]">
            ...
            <div className="mb-5">
                    ...
                    <input type="text" placeholder="Sharp" className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#5faed5]"/>
                </div>
                <div className="mb-5">
                ...
                <button className="w-full py-2 bg-[#5fbbd5] text-white font-bold rounded-md transition-transform duration-300 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 transform hover:scale-105">Register</button>
            </form>
